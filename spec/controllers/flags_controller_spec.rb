...
RSpec.describe FlagsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all flags as @flags" do
      ...
      expect(assigns(:flags)).to eq([flag])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved flag as @flag" do
        post :create, {:flag => invalid_attributes}, valid_session
        expect(assigns(:flag)).to be_a_new(Flag)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested flag" do
        flag = Flag.create! valid_attributes
        put :update, {:id => flag.to_param, :flag => new_attributes}, valid_session
        flag.reload
    ...
    context "with invalid params" do
      it "assigns the flag as @flag" do
        flag = Flag.create! valid_attributes
        put :update, {:id => flag.to_param, :flag => invalid_attributes}, valid_session
        expect(assigns(:flag)).to eq(flag)
      end
